...
(function (global) {
  ...
  XiangQi.prototype = {
    ...
    /**
     * Re-size the current XiangQi board to given <newWidth>.
     * If side bar is present, it will be resized to the same ratio.
     *
     * Note that <newWidth> has to be greater or equal to 200.
    ...
    /**
     * Update the XiangQi board state using given <moveInput> and draw out the
     * updated board content. The function will report error if either the
     * <moveInput> is invalid or if the move is invalid.
     *
     * <moveInput> can be a string in the form of '[old position]-[new position]',
     * e.g. 23-25, where 2 represent row of old position, 3 represent column of
     * old position, and so on. <moveInput> can also be a move object in the
     * form of { oldPos: *, newPos: * }
     *
     ...
     * If <boardContent> is provided, then the function will update the current
     * board content with given one and draw it out on the XiangQi board.
     *
     * <boardContent> can either be a FEN string representing the state of the
     * board, or a 2D-array of Piece object. Anything else passed in will result
     * in error.
     *
     * @param boardContent {Array[][] | String} The board content to be displayed and stored.
     */
    ...
    /**
     * Removes clear all pieces from both the physical XiangQi board as well as
     * virtual XiangQi board. If <clearVirtual> is set to false, then the clear
     * will only reflect on the DOM.
     *
     * @param clearVirtual {boolean} Determines whether to clear virtual board or not.
     */
    ...
    /**
     * Draw out given <piece> at position (<row>, <col>).
     * If the position is already occupied, then the function will report error.
     *
     * @param row {number} the row number of the new piece position.
     * @param col {number} the column number of the new piece position.
     * @param piece {string} the type of the piece.
     * @param side {string} the side of the piece.
     */
    ...
    /**
     * Remove the piece from position (<row>, <col>).
     * If the position is empty, then the function will report error.
     *
     * @param row {number} the row number of the piece to be removed.
     * @param col {number} the column number of the piece to be removed.
     */
    ...
    /**
     * Add the side panel showing piece counts for current state of the board
     * to the DOM. If a side bar is already present, then the function will
     * update the side bar content.
     */
    ...
    /**
     * Removes the side bar from the DOM. If there is no side bar,
    ...
    /**
     * Enables void pieces such that clickable will be allowed to void
     * non-friendly pieces.
     */
    ...
    /**
     * Disables void pieces such that clickable will not be allowed to
     * void any pieces.
     */
    ...
    /**
     * Makes all pieces on current XiangQi board draggable. `makeDraggable`
     * will disable clickable feature upon call.
     */
    ...
    /**
     * Makes all pieces on current XiangQi board clickable.
     * `makeClickable` will disable draggable feature upon call.
     */
